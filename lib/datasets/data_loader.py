...
from lib.datasets.loader.thermalFaceDB_loader import ThermalFaceDBLoader
from lib.datasets.loader.lip_loader import LipLoader
from lib.datasets.loader.offset_loader import DTOffsetLoader, SWOffsetTestLoader
...
class DataLoader(object):
    ...
    def get_trainloader(self):
        if self.configer.exists('data', 'use_edge') and self.configer.get('data', 'use_edge') == 'ce2p':
            ...
            Log.info('use ThermalFaceDBLoader (diverse input shape) for train...')
